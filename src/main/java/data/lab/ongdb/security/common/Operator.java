...
public enum Operator {
     ...
     * 1、对已有数据的编辑修改权限
     **/
    EDITOR("editor", 1,"【对已有数据的编辑修改权限】"),

    /**
     * 1、对已有数据的编辑修改权限
     * 2、拥有创建新数据权限
     **/
    PUBLISHER("publisher", 2,"【对已有数据的编辑修改权限】【拥有创建新数据权限】"),
     ...
     **/
    DELETER_RESTRICT("deleter_restrict", 3,"【对已有数据的编辑修改权限】【拥有删除数据权限-仅允许删除用户自己创建的数据】"),
     ...
     **/
    DELETER("deleter", 4,"【对已有数据的编辑修改权限】【拥有创建新数据权限-允许删除用户自己创建的数据】【拥有删除数据权限-可以删除其它用户创建的数据】");
